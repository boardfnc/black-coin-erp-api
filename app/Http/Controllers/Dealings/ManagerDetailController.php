...
use App\Http\Requests\Dealings\ManagerDetail;
...
class ManagerDetailController extends Controller
{
    /**
     * @OA\Get(
     *     path="/dealings/manager-details",
     *     summary="거래 내역 목록 ",
     *     tags={"Dealings"},
     *     description="거래 내역 에 대한 정보를 리스트 형태로 받을 수 있습니다.",
     *
     *     @OA\Parameter(
     ...
     *         description="성공",
     *         @OA\JsonContent(
     *             @OA\Property(property="data", ref="#/components/schemas/DealingsManagerDetailsGet_BcCaDelngDtlsCollection"),
    ...
    public function index(ManagerDetail $request)
    {
        $user = auth()->user();
        ...
        $data = BcCaDelngDtls::where('mngr_id', $mngr_id);
    ...
    /**
     * @OA\Get(
     *     path="/dealings/manager-detail/history",
     *     summary="거래 내역 상세 이력",
     *     tags={"Dealings"},
     *     description="거래 내역 상세 이력에 대한 정보를 리스트 형태로 받을 수 있습니다.",
     *
     *     @OA\Parameter(
     *         name="page",
     *         in="query",
     ...
     *         description="성공",
     *         @OA\JsonContent(
     *             @OA\Property(property="data", ref="#/components/schemas/DealingsManagerDetailHistoryGet_BcCaDelngDtlsChghstCollection"),
     *             @OA\Property(property="status", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="success"),
     *             @OA\Property(property="pagination", type="object",
     *                 @OA\Property(property="total", type="integer", example="100"),
    ...
    public function history(ManagerDetail $request)
    {
        $user = auth()->user();
        $mngr_id = $user->mngr_id;
        ...
        $data = BcCaDelngDtlsChghst::where('mngr_id', $mngr_id);
