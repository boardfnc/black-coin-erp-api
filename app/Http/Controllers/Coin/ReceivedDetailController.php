...
class ReceivedDetailController extends Controller
{
    /**
     * @OA\Get(
     *     path="/coin/received-details",
     *     summary="받은 코인 내역 목록",
     *     tags={"Coin"},
     ...
     *         name="search_type",
     *         in="query",
     *         description="검색 타입(login_id:회원 아이디, nm:회원명)",
     *         @OA\Schema(
     *             type="string", enum={"login_id", "nm"}, example="login_id", default="login_id"
     *         ),
     *     ),
     *     @OA\Parameter(
     *         name="search_keyword",
     ...
     *         description="성공",
     *         @OA\JsonContent(
     *             @OA\Property(property="data", ref="#/components/schemas/CoinReceivedDetailsGet_BcMberExchngDtlsCollection"),
    ...
    public function index(AdminReceivedDetail $request)
    {
        ...
        $data = BcMberExchngDtls::where('mngr_id', $mngr_id)->where('exchng_se', '1')->with(
            'bcMber'
        );
