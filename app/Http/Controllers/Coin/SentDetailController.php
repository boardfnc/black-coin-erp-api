...
class SentDetailController extends Controller
{
    /**
     * @OA\Get(
     *     path="/coin/sent-details",
     *     summary="보낸 코인 내역 목록",
     *     tags={"Coin"},
     ...
     *         description="성공",
     *         @OA\JsonContent(
     *             @OA\Property(property="data", ref="#/components/schemas/CoinSentDetailsGet_BcMberExchngDtlsCollection"),
    ...
    public function index(AdminSentDetail $request)
    {
        ...
        $data = BcMberExchngDtls::where('mngr_id', $mngr_id)->where('exchng_se', '2')->with(
            'bcMber'
        );
