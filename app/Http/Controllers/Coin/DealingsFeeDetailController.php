...
class DealingsFeeDetailController extends Controller
{
    /**
     * @OA\Get(
     *     path="/coin/dealings-fee-details",
     *     summary="거래 수수료 내역 목록",
     *     tags={"Coin"},
     ...
     *         description="성공",
     *         @OA\JsonContent(
     *             @OA\Property(property="data", ref="#/components/schemas/CoinDealingsFeeDetailsGet_BcDelngFeeDtlsCollection"),
    ...
    public function index(AdminDealingsFeeDetail $request)
    {
        ...
        $data = BcDelngFeeDtls::where('mngr_id', $mngr_id)->with(
            'bcMber'
        );
